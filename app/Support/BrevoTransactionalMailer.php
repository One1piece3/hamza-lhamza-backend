        ...
        $html = new HtmlString(<<<HTML
            <div style="margin:0;padding:28px 0;background:#fff3ed;font-family:Georgia,'Times New Roman',serif;color:#1f2937;">
                <div style="max-width:620px;margin:0 auto;background:#ffffff;border:1px solid #f2c9ba;border-radius:22px;overflow:hidden;">
                    <div style="padding:28px 32px;background:#3a2827;border-bottom:1px solid #5c3834;">
                        <p style="margin:0 0 8px;font-family:Arial,sans-serif;font-size:12px;letter-spacing:1.8px;text-transform:uppercase;color:#ffb29e;">
                            Hamza Lhamza
                        </p>
                        <h1 style="margin:0;font-size:30px;line-height:1.2;color:#ffffff !important;-webkit-text-fill-color:#ffffff;">
