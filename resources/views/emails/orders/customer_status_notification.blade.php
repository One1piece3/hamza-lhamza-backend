    ...
    <div style="max-width:680px; margin:0 auto; padding:34px 18px;">
        <div style="background:#fffaf7; border:1px solid rgba(214,176,156,0.72); border-radius:30px; overflow:hidden; box-shadow:0 24px 50px rgba(155,94,76,0.14);">
            <div style="padding:26px 30px; background:radial-gradient(circle at top right, rgba(255,255,255,0.18), transparent 32%), linear-gradient(145deg, #2d2630 0%, #45323b 55%, #93534f 100%); color:#fff7f2;">
                ...
                <h1 style="margin:0; font-size:31px; line-height:1.1; font-family:Georgia, 'Times New Roman', serif;">{{ $status_label }}</h1>
                <p style="margin:12px 0 0; font-size:14px; line-height:1.7; color:rgba(255,240,235,0.84);">
                    Une experience boutique plus claire, plus elegante et suivie a chaque etape.
                </p>
            </div>

            <div style="padding:28px 30px 30px;">
                <p style="margin:0 0 22px; font-size:15px; line-height:1.8; color:#5a6170;">
                ...
                <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:12px; margin-bottom:22px;">
                    ...
                    <div style="background:#ffffff; border:1px solid rgba(228,190,170,0.58); border-radius:18px; padding:16px;">
                        <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.9px; color:#9f7d72; margin-bottom:6px;">Statut</div>
                        <strong style="color:#1f2430; font-size:16px;">{{ $status_label }}</strong>
                    </div>
                    <div style="background:#ffffff; border:1px solid rgba(228,190,170,0.58); border-radius:18px; padding:16px;">
                    ...
                    <div style="background:#ffffff; border:1px solid rgba(228,190,170,0.58); border-radius:18px; padding:16px;">
                        <div style="font-size:11px; text-transform:uppercase; letter-spacing:0.9px; color:#9f7d72; margin-bottom:6px;">Ville</div>
                        <strong style="color:#1f2430; font-size:16px;">{{ $order->customer_city }}</strong>
                    </div>
                </div>

                <h2 style="margin:0 0 12px; font-size:18px; color:#1f2430; font-family:Georgia, 'Times New Roman', serif;">Votre selection</h2>
                ...
                <div style="background:rgba(255,126,95,0.08); border:1px solid rgba(255,126,95,0.16); border-radius:18px; padding:16px 18px; margin-bottom:18px;">
                    <p style="margin:0; font-size:14px; line-height:1.8; color:#5f6575;">
                        Besoin d aide ? Repondez directement a cet email ou contactez la boutique via Instagram et WhatsApp pour un accompagnement plus rapide.
                    </p>
                </div>

                <p style="margin:0; font-size:13px; line-height:1.8; color:#7c7f8a; text-align:center;">
                    Hamza Lhamza • Instagram @hamza_lhamza7 • WhatsApp 0776683632
                </p>
            </div>
        </div>
    </div>
